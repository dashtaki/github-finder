const getUserWhileUSerIsTyping = () => {
    cy.intercept(
        {
            method: 'POST',
...
describe('SearchUser', () => {
    ...
    it('should show user avatar', () => {
        ...
        cy.get('ul li:first-child img').should('have.attr', 'src', expectedImg);
    });
    ...
    it('should show user name', () => {
        ...
        cy.get('ul li:first-child .user-detail__name').should('contain', expectedName);
    });
    ...
    it('should show "No Name" when user does not have name', () => {
        ...
        cy.get('ul li:nth-child(2) .user-detail__name').should('contain', expectedName);
    });
    ...
    it('should show user followers count', () => {
        ...
        cy.get('ul li:first-child .user-detail__wrapper small:nth-child(2)').should('contain', expectedName);
    });
    ...
    it('should show user following count', () => {
        ...
        cy.get('ul li:first-child .user-detail__wrapper small:nth-child(3)').should('contain', expectedName);
    });
    ...
    it('should put name in input on user click', () => {
        ...
        cy.get('#search-input').should('have.value', 'reid')
    });
    ...
    it('should show message when API error happened', () => {
        ...
        cy.get('.api-error__wrapper').should('have.length', 1);
    });
    ...
    it('should show message when there is not any user', () => {
        cy.intercept(
            ...
            {fixture: '../fixtures/no_user.json'}
        );
        cy.get('#search-input').type('a');

        cy.get('.user-not-found__text').should('contain', 'No Users found!');
    });
    ...
    it('should route to repositories page', () => {
        ...
        cy.location().should(location => expect(location.pathname).to.eq('/repositories/sad'));
    });
